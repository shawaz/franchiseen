...
export function UnifiedAuth({ 
  ...
  const downloadWalletFile = () => {
    if (!generatedWallet || !email) {
      console.error('Missing wallet or email for PDF download');
      return;
    }
    ...
    try {
      ...
      doc.text('WARNING: Never share this private key with anyone!', 20, 165);
      ...
      const content = `
FRANCHISEEN WALLET INFORMATION
==============================
...
Store this securely and never lose it - it cannot be recovered!

Generated by Franchiseen Platform
`;
      ...
      a.href = url;
      a.download = `franchiseen-wallet-${email.split('@')[0]}-${Date.now()}.txt`;
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
      
      console.log('Downloaded as text file due to PDF error');
    }
  };
