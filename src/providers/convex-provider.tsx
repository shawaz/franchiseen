 ...
 *   franchiseen.com / app.franchiseen.com   → PRODUCTION (NEXT_PUBLIC_CONVEX_URL_PRODUCTION)
 *   dev.franchiseen.com / localhost / any other → STAGING (NEXT_PUBLIC_CONVEX_URL_STAGING)
 */
