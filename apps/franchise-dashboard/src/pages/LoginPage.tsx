    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 flex items-center justify-center rounded-full bg-gradient-to-r from-primary-600 to-purple-600 shadow-lg">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to manage your fintech franchise
          </p>
        </div>
        ...
        <div className="card card-body">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder="owner@demo-franchise.com"
                />
                {errors.email && (
          ...
          <div className="mt-4 text-center">
            <div className="flex items-center justify-center space-x-2 text-xs text-gray-500">
              <span className="badge-crypto">New</span>
              <span>Solana Pay Integration Available</span>
            </div>
          </div>
        </div>
      </div>
